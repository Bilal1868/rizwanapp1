...
import 'package:rizwan_app/desk_page.dart';

class DeskLoginPage extends StatefulWidget {
  const DeskLoginPage({super.key});

  @override
  State<DeskLoginPage> createState() => _LoginPageState();
}

class _LoginPageState extends State<DeskLoginPage> {
                      ...
                      child: MaterialButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (_) => MyDesktopPage()));
                        },
                        height: defaultSize2 + defaultSize,
                        minWidth: width * 0.42,
                        color: mainColor,
