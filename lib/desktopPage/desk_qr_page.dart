...
class DeskQRPage extends StatefulWidget {
  const DeskQRPage({super.key});

  @override
  State<DeskQRPage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<DeskQRPage> {
