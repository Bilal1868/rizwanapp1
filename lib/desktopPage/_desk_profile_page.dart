...
class DeskProfilePage extends StatefulWidget {
  const DeskProfilePage({super.key});

  @override
  State<DeskProfilePage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<DeskProfilePage> {
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  height: 6,
                  width: defaultSize2 * 3,
                  decoration: BoxDecoration(
                      color: Color.fromARGB(255, 103, 175, 10),
                      borderRadius: BorderRadius.circular(5)),
                ),
              ],
            ),
